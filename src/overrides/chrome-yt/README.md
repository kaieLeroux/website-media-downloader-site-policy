...
This is the **Chrome-YT** build, which includes full support for YouTube media detection and downloading using the local YouTube API client.
...
Build output goes to `build/chrome-yt/`, containing a ready-to-load extension.
...
### Chrome / Chromium
1. Run `node src/build.js chrome-yt`
2. Open `chrome://extensions/` and enable **Developer mode**
3. Click **Load unpacked** and select the `build/chrome-yt/` folder
